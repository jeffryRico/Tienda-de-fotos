...
module.exports = {
  ...
  agregarCarroCompra: async (peticion, respuesta) => {
    ...
    if(foto) {
      peticion.addFlash('mensaje', 'La foto ya se agrego al carro de compra');
    }
    else {
      ...
      peticion.addFlash('mensaje', 'Foto agregada al carro de compras');
    }
  ...
  eliminarCarroCompra: async (peticion, respuesta) => {
    ...
    if(foto){
      ...
      peticion.session.carroCompra = await CarroCompra.find({ cliente: peticion.session.cliente.id });
      peticion.addFlash('mensaje', 'Foto eliminada del carro de compras');
    }
  ...
  agregarListaDeseo: async (peticion, respuesta) => {
    ...
    if (foto) {
      peticion.addFlash('mensajes', 'La foto ya habia sido agregada a la lista de deseos');
    }
    else {
  ...
  eliminarListaDeseo: async (peticion, respuesta) => {
    ...
    if(foto){
      ...
      peticion.addFlash('mensaje', 'Foto eliminada de la lista de deseos');
    }
